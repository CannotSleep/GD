...
namespace Temp.Core.Util
{
    public class JSONHelper
    {
        ...
        public static string ToJson(object item)
        {
            ...
            return JsonConvert.SerializeObject(item, timeFormat).Replace("\"0\"", "\"\"");
        }
        ...
        /// <param name="truSuggest"></param>
        /// <param name="falseSuggest"></param>
        /// <returns></returns>
        public static string ToJsonBool(bool flag,string trueSuggest,string falseSuggest) {
            return (flag ? trueSuggest : falseSuggest);
        }
        ...
        /// <summary>
        /// Json序列化,用于发送到客户端,格式适配layui
        /// </summary>
        /// <param name="item"></param>
        /// <param name="total">返回的行数</param>
        /// <returns></returns>
        /// <remarks></remarks>
        public static string ToJson(object item, int total)
        {
            StringBuilder jsonBuilder = new StringBuilder();
            jsonBuilder.Append("{\"code\":0,\"msg\":\"\"");
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public static string ToJsonAngular(object item)
        {
            IsoDateTimeConverter timeFormat = new IsoDateTimeConverter();
            timeFormat.DateTimeFormat = "yyyy-MM-dd HH:mm:ss";
            return JsonConvert.SerializeObject(item, timeFormat).Replace("\"0\"", "");
        ...
        /// <summary>
        /// Json序列化,用于发送到客户端,格式适配Angular
        /// </summary>
        /// <param name="item"></param>
        /// <param name="total">返回的行数</param>
        /// <returns></returns>
        /// <remarks></remarks>
        public static string ToJsonAngular(object item, int total)
        {
            StringBuilder jsonBuilder = new StringBuilder();
            jsonBuilder.Append("{\"code\":0,\"msg\":\"\"");
            jsonBuilder.Append(",\"count\"");
            ...
            jsonBuilder.Append(total);
            jsonBuilder.Append("\",\"data\":");
            jsonBuilder.Append(ToJsonAngular(item));
            jsonBuilder.Append("}");
            return jsonBuilder.ToString().Replace("\"0\"", "");
        }
        ...
        /// <summary>
        /// Json序列化,用于发送到客户端,格式适配LAYUI图片展示
        /// </summary>
        /// <returns></returns>
        /// <remarks></remarks>
        public static string ToJsonPhoto(string src)
        {
            StringBuilder jsonBuilder = new StringBuilder();
            jsonBuilder.Append("{\"title\":\"0\",\"id\":123,\"start\":0");
            jsonBuilder.Append(",\"data\"");
            jsonBuilder.Append(":[{");
            jsonBuilder.Append("\"alt\":\"666\",\"pid\":555,");
            jsonBuilder.Append("\"src\":\"");
            jsonBuilder.Append(src);
            jsonBuilder.Append("\",\"thumb\":\"");
            jsonBuilder.Append(src);
            jsonBuilder.Append("\"}]}");
            return jsonBuilder.ToString();
        }
