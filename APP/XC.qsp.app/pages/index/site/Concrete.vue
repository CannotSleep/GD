	...
	<view class="content">
		...
		<view class="input-row">
			...
			<picker @change="changeComponent" :value="ComponentIndex" :range="ComponentList" range-key="text">
				<view class="uni-input">{{ComponentText}}</view>
			</picker>
		</view>
		<view class="input-row">
			<view class="input-label">
	...
	export default {
		...
		methods: {
			...
			changeComponent(e) {
				...
				this.ComponentVal = this.ComponentList[this.ComponentIndex].value;
				this.ComponentText=this.ComponentList[this.ComponentIndex].text;
			...
			submit() {
				...
				let ajaxdata = {
					...
					ComponentType:this.ComponentText,
