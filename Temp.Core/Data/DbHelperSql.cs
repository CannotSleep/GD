...
namespace Temp.Core.Data
{
    ...
    public abstract class DbHelperSql
    {
        ...
        #region 默认的连接字符串
        //todo
        //public static string DefaultUpdateConn = DesEncrypt.Decrypt(ConfigHelper.GetConfigString("UpdateConnection"));
        //public static string DefaultQueryConn = DesEncrypt.Decrypt(ConfigHelper.GetConfigString("QueryConnection"));
        public static string DefaultUpdateConn = ConfigHelper.GetConfigString("UpdateConnection");
        public static string DefaultQueryConn = ConfigHelper.GetConfigString("QueryConnection");
        #endregion
    }
}
